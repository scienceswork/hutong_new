...
@section('jumbotron')
    ...
    <div class="jumbotron text-center">
        <h4>{{ Setting()->get('website_welcome','现在加入Tipask问答网，一起记录站长的世界') }}</h4>
        <h4><a class="btn btn-primary ml-10" href="{{ route('auth.user.register') }}" role="button">立即注册</a> <a class="btn btn-default ml-5" href="{{ route('auth.user.login') }}" role="button">用户登录</a></h4>
    </div>
    @endif
@endsection
        ...
        <div class="col-xs-12 col-md-9 main">
            ...
            @if($hotExperts)
                <div class="widget-box clearfix">
                    <h4 class="widget-box-title">推荐大V <a href="{{ route('website.experts') }}" title="更多">»</a></h4>
