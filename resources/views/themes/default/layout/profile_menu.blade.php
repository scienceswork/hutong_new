<div id="secondary" class="col-md-2">
    <nav class="list-group mt-20">
        ...
        <a href="{{ route('auth.authentication.index') }}" class="list-group-item @if(str_contains(request()->route()->getName(),'auth.authentication')) active @endif" ><span class="fa fa-graduation-cap" aria-hidden="true"></span> 大V认证</a>
