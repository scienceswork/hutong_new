...
<head>
    ...
    <meta name="copyright" content="2016 hj-ht.com" />
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <div class="logo">
                    <a class="navbar-brand logo" href="{{ route('website.index') }}" style="color: #fff;">
                        后街胡同
                    </a>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="global-navbar">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->route()->getName() == 'website.experts') class="active" @endif><a href="{{ route('website.experts') }}">大V</a></li>
...
<footer id="footer">
    <div class="container">
        ...
        <div class="copyright mt-10">
            Powered By <a href="http://www.hj-ht.com" target="_blank">后街胡同</a> ©2016-{{ gmdate('Y') }} hj-ht.com
        </div>
    </div>
</footer>
@if(Auth()->check() && Auth()->user()->status===0)
